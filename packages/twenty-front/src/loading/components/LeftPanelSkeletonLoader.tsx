...
// Mirrors the real NavigationDrawer geometry so the loading skeleton has the
// exact same menu width: a NAVIGATION_DRAWER_CONSTRAINTS.default-wide,
// border-box panel with the drawer's own padding, left-aligned.
